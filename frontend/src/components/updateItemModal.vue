        ...
        <div class="modal-body">
          <form @submit.prevent="submitForm">
            ...
            <div class="mb-3">
              ...
              <input type="number" id="price" class="form-control" v-model="selectedItem.price" required min="0" step="0.01" />
            </div>
            ...
            <div class="mb-3">
              ...
              <select id="unit" class="form-select" v-model="selectedItem.unit" required>
            ...
            <div class="mb-3">
              ...
              <input type="number" id="threshold" class="form-control" v-model="selectedItem.threshold" required min="0" />
            </div>
...
export default {
  ...
  methods: {
    async submitForm() {
      try {
        const response = await axios.put(`http://localhost:5000/api/inventory/update-item/${this.item.itemId}`, this.selectedItem);      
        console.log('Item updated successfully:', response.data);
        alert('Item updated successfully.');
        this.$emit('item Updated', response.data.item);  // Emit success event
