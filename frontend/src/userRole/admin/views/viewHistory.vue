    ...
    <div class="flex">
      ...
      <div class="flex-1 p-8 overflow-hidden">
        <div class="max-w-7xl mx-auto">
          <h2 class="text-3xl font-bold text-gray-900 mb-6">Transaction History</h2>
                  ...
                  <tr v-for="history in paginatedData" :key="history.transactionId" class="hover:bg-gray-50">
                    <td
                      ...
                      :class="[
                        ...
                        header.key === 'quantityChanged' ? quantityColor(history[header.key]) : 'text-gray-500'
                      ]"
                    >
                      {{ formatCellData(history[header.key], header.key) }}
                    </td>
                  </tr>
                </tbody>
              </table>
