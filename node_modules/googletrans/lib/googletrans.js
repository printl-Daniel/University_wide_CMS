...
exports.getResult = exports.translate = exports.googletrans = void 0;
...
function translate(text, opts) {
    return __awaiter(this, void 0, void 0, function () {
        var _opts, _text, e, FROMTO, str, i, t, e_1, URL, TOKEN, PARAMS, HEADERS, res;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    FROMTO.forEach(function (lang) {
                        if (lang && !(0, languages_1.isSupported)(lang)) {
                            e = new Error("The language \u300C".concat(lang, "\u300Dis not suppored!"));
                            throw e;
                        }
                    });
                    ...
                    _opts.from = (0, languages_1.getCode)(_opts.from);
                    _opts.to = (0, languages_1.getCode)(_opts.to);
                    URL = "https://translate.google." + _opts.tld + "/translate_a/single";
                    TOKEN = (0, googleToken_1.getToken)(_text);
                    PARAMS = {
                        client: _opts.client,
                        sl: _opts.from,
                        tl: _opts.to,
